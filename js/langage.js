function translateMessage() {
    ...
    const greetingsEN = [
        ...
        "Enjoy the festive season and appreciate the traditions.",
        "Warm regards,",
        "G.M.P.Sankalpa",
    ...
    const greetingsSI = [
        "ඔබටත් ඔබේ පවුලේ සැමටත් සතුට සෞභාග්‍ය සපිරි සුභ සිංහල හින්දු අලුත් අවුරුද්දක් වේවා!",
        "මේ අලුත් අවුරුද්දේ ඔබට නිදුක් නිරෝගී, සතුට, සාර්ථකත්වය උදා වේවා.",
        "උත්සව සමය සතුටින් භුක්ති විදිමින් සම්ප්‍රදායන් අගය කරන්න.",
        "උණුසුම් සුභාශිංෂන,",
        "ජී.එම්.පි.සංකල්ප",
        "සුභ අලුත් අවුරුද්දක්! මෙන්න ඔබ සඳහා පමණක් සැඟවුණු පණිවිඩයක්!"
    ];
    ...
    const greetingsTA = [
        ...
        "பண்டிகைக் காலத்தை அனுபவித்து, மரபுகளைப் பாராட்டுங்கள்.",
